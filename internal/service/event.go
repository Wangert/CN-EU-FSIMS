...
const (
	...
	PASTURE_ABNORMAL_BASIC_ENVIRONMENT_INDEX_CONTENT = "牧场基本环境指数异常"
	PASTURE_ABNORMAL_BUFFER_INDEX_CONTENT            = "牧场缓冲区环境指数异常"
	PASTURE_ABNORMAL_AREA_INDEX_CONTENT              = "牧场场区环境指数异常"
	PASTURE_ABNORMAL_COWHOUSE_INDEX_CONTENT          = "牧场牛舍环境指数异常"
	PASTURE_ABNORMAL_PADDING_INDEX_CONTENT           = "牧场垫料指数异常"
