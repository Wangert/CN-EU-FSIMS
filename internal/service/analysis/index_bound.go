...
var SlaughterPreCoolShopUpperBounds = map[string]float64{"pre_cool_shop_1": PreCoolShop1_MAX, "pre_cool_shop_2": PreCoolShop2_MAX, "pre_cool_shop_3": PreCoolShop3_MAX}
var SlaughterPreCoolShopLowerBounds = map[string]float64{"pre_cool_shop_1": PreCoolShop1_MIN, "pre_cool_shop_2": PreCoolShop2_MIN}

var SlaughterSlaShopUpperBounds = map[string]float64{"sla_shop_3": SlaShop3_MAX, "sla_shop_5": SlaShop5_MAX, "sla_shop_7": SlaShop7_MAX, "sla_shop_8": SlaShop8_MAX}
var SlaughterSlaShopLowerBounds = map[string]float64{"sla_shop_2": SlaShop2_MIN, "sla_shop_4": SlaShop4_MIN, "sla_shop_7": SlaShop7_MIN, "sla_shop_8": SlaShop8_MIN, "sla_shop_9": SlaShop9_MIN}

var SlaughterDivShopUpperBounds = map[string]float64{"div_shop_3": DivShop3_MAX, "div_shop_5": DivShop5_MAX, "div_shop_7": DivShop7_MAX, "div_shop_8": DivShop8_MAX}
var SlaughterDivShopLowerBounds = map[string]float64{"div_shop_2": DivShop2_MIN, "div_shop_4": DivShop4_MIN, "div_shop_7": DivShop7_MIN, "div_shop_8": DivShop8_MIN, "div_shop_9": DivShop9_MIN}

var SlaughterAcidShopUpperBounds = map[string]float64{"acid_shop_3": AcidShop3_MAX, "acid_shop_5": AcidShop5_MAX, "acid_shop_7": AcidShop7_MAX, "acid_shop_8": AcidShop8_MAX}
var SlaughterAcidShopLowerBounds = map[string]float64{"acid_shop_2": AcidShop2_MIN, "acid_shop_4": AcidShop4_MIN, "acid_shop_7": AcidShop7_MIN, "acid_shop_8": AcidShop8_MIN, "acid_shop_9": AcidShop9_MIN}

var SlaughterFroShopUpperBounds = map[string]float64{"fro_shop_3": FroShop3_MAX, "fro_shop_5": FroShop5_MAX, "fro_shop_7": FroShop7_MAX, "fro_shop_8": FroShop8_MAX}
var SlaughterFroShopLowerBounds = map[string]float64{"fro_shop_2": FroShop2_MIN, "fro_shop_4": FroShop4_MIN, "fro_shop_7": FroShop7_MIN, "fro_shop_8": FroShop8_MIN, "fro_shop_9": FroShop9_MIN}
