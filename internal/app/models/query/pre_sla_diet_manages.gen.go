...
func newPreSlaDietManage(db *gorm.DB, opts ...gen.DOOption) preSlaDietManage {
	...
	_preSlaDietManage.preSlaDietManageDo.UseModel(&slaughter.PreSlaDietManage{})
	...
	_preSlaDietManage.PID = field.NewString(tableName, "p_id")
...
type IPreSlaDietManageDo interface {
	...
	Create(values ...*slaughter.PreSlaDietManage) error
	CreateInBatches(values []*slaughter.PreSlaDietManage, batchSize int) error
	Save(values ...*slaughter.PreSlaDietManage) error
	First() (*slaughter.PreSlaDietManage, error)
	Take() (*slaughter.PreSlaDietManage, error)
	Last() (*slaughter.PreSlaDietManage, error)
	Find() ([]*slaughter.PreSlaDietManage, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*slaughter.PreSlaDietManage, err error)
	FindInBatches(result *[]*slaughter.PreSlaDietManage, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*slaughter.PreSlaDietManage) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*slaughter.PreSlaDietManage, error)
	FirstOrCreate() (*slaughter.PreSlaDietManage, error)
	FindByPage(offset int, limit int) (result []*slaughter.PreSlaDietManage, count int64, err error)
...
func (p preSlaDietManageDo) Create(values ...*slaughter.PreSlaDietManage) error {
	if len(values) == 0 {
		return nil
	}
...
func (p preSlaDietManageDo) CreateInBatches(values []*slaughter.PreSlaDietManage, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p preSlaDietManageDo) Save(values ...*slaughter.PreSlaDietManage) error {
	if len(values) == 0 {
		return nil
	}
...
func (p preSlaDietManageDo) First() (*slaughter.PreSlaDietManage, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*slaughter.PreSlaDietManage), nil
	}
}

func (p preSlaDietManageDo) Take() (*slaughter.PreSlaDietManage, error) {
...
func (p preSlaDietManageDo) Last() (*slaughter.PreSlaDietManage, error) {
...
func (p preSlaDietManageDo) Find() ([]*slaughter.PreSlaDietManage, error) {
	result, err := p.DO.Find()
	return result.([]*slaughter.PreSlaDietManage), err
}

func (p preSlaDietManageDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*slaughter.PreSlaDietManage, err error) {
	buf := make([]*slaughter.PreSlaDietManage, 0, batchSize)
...
func (p preSlaDietManageDo) FindInBatches(result *[]*slaughter.PreSlaDietManage, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p preSlaDietManageDo) FirstOrInit() (*slaughter.PreSlaDietManage, error) {
...
func (p preSlaDietManageDo) FirstOrCreate() (*slaughter.PreSlaDietManage, error) {
...
func (p preSlaDietManageDo) FindByPage(offset int, limit int) (result []*slaughter.PreSlaDietManage, count int64, err error) {
...
func (p preSlaDietManageDo) Delete(models ...*slaughter.PreSlaDietManage) (result gen.ResultInfo, err error) {
