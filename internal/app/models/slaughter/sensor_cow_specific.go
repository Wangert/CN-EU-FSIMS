...
type SlaughterProcedureMonitoringData struct {
	gorm.Model
	PID                                string                             `json:"pid"`
	SlaughterDisinfectHotWaterTempMoni SlaughterDisinfectHotWaterTempMoni `gorm:"foreignKey:SlaughterProcedureMonitoringDataID; references:ID" json:"slaughter_disinfect_hot_water_temp_moni"`
	SlaughterStun                      SlaughterStun                      `gorm:"foreignKey:SlaughterProcedureMonitoringDataID; references:ID" json:"slaughter_stun"`
	BleedElectronic                    BleedElectronic                    `gorm:"foreignKey:SlaughterProcedureMonitoringDataID; references:ID" json:"bleed_electronic"`
	AnalMeatPhMoni                     AnalMeatPhMoni                     `gorm:"foreignKey:SlaughterProcedureMonitoringDataID; references:ID" json:"anal_meat_ph_moni"`
	ToNumGermMon                       ToNumGermMon                       `gorm:"foreignKey:SlaughterProcedureMonitoringDataID; references:ID" json:"to_num_germ_mon"`
}
...
type PreSlaDietManage struct {
	...
	gorm.Model
	PID               string    `json:"pid"`
	PreSlaDietManage1 time.Time `json:"pre_sla_diet_manage_1"` //牛进场时间
	PreSlaDietManage2 time.Time `json:"pre_sla_diet_manage_2"` //牛停水时间
	PreSlaDietManage3 time.Time `json:"pre_sla_diet_manage_3"` //牛禁食时间
	PreSlaDietManage4 time.Time `json:"pre_sla_diet_manage_4"` //饮水时间
	PreSlaDietManage5 time.Time `json:"pre_sla_diet_manage_5"` //送宰时间
}
