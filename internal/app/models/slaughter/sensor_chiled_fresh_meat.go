...
type ChiledFreshIndex struct {
	...
	TranTemp            float64             `json:"tran_temp"` //运输温度
}
...
type SlaughterPaGerm struct {
	...
	PaGerm1            float64 `json:"pa_germ_1"` //光谱监测沙门
	PaGerm2            float64 `json:"pa_germ_2"` //STEC
	PaGerm3            float64 `json:"pa_germ_3"` //李斯特
	PaGerm4            float64 `json:"pa_germ_4"` //阪崎杆菌
	PaGerm5            float64 `json:"pa_germ_5"` //金葡
}
...
type SlaughterOtherIndex struct {
	...
	gorm.Model
	ChiledFreshIndexID *uint   `json:"chiled_fresh_index_id"`
	OtherIndex1        float64 `json:"other_index_1"` //菌落总数（光谱）
	OtherIndex2        float64 `json:"other_index_2"` //挥发性盐基氮（光谱）
	OtherIndex3        float64 `json:"other_index_3"` //大肠菌群（光谱）
	OtherIndex4        float64 `json:"other_index_4"` //假单胞
	OtherIndex5        float64 `json:"other_index_5"` //乳酸菌（光谱）
	OtherIndex6        float64 `json:"other_index_6"` //铅
	OtherIndex7        float64 `json:"other_index_7"` //无机砷
	OtherIndex8        float64 `json:"other_index_8"` //牛肉水分
	OtherIndex9        float64 `json:"other_index_9"` //牛肉蛋白质
}
...
type SlaughterDrugsResi struct {
	...
	gorm.Model
	ChiledFreshIndexID *uint   `json:"chiled_fresh_index_id"`
	DrugsResi1         float64 `json:"drugs_resi_1"` //恩诺沙星
	DrugsResi2         float64 `json:"drugs_resi_2"` //庆大霉素
	DrugsResi3         float64 `json:"drugs_resi_3"` //青霉素
	DrugsResi4         float64 `json:"drugs_resi_4"` //氯氢吡啶
}
