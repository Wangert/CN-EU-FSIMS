...
type PreCoolShop struct {
	...
	TimeRecordAt float32 `json:"time_record_at"`  //记录时间
...
//	//消毒记录
//	gorm.Model
//	TimeRecordAt float32 `json:"time_record_at"` //消毒记录 记录时间
//	DisRecord1   string  `json:"dis_record_1"`   //消毒记录 方式
//	DisRecord2   float32 `json:"dis_record_2"`   //消毒记录 浓度
//	DisRecord3   string  `json:"dis_record_3"`   //消毒记录 班次
//	DisRecord4   string  `json:"dis_record_4"`   //消毒记录 器具
//	DisRecord5   string  `json:"dis_record_5"`   //消毒记录 环境
//}

// Info 用于返回
type DisinfectRecordInfo struct {
