...
func newAcidShop(db *gorm.DB, opts ...gen.DOOption) acidShop {
	...
	_acidShop.AcidShop10 = field.Newfloat64(tableName, "acid_shop10")
	_acidShop.AcidShop11 = field.Newfloat64(tableName, "acid_shop11")
	_acidShop.AcidShop12 = field.Newfloat64(tableName, "acid_shop12")
	_acidShop.AcidShop13 = field.Newfloat64(tableName, "acid_shop13")
	_acidShop.AcidShop14 = field.Newfloat64(tableName, "acid_shop14")
...
type acidShop struct {
	...
	AcidShop10   field.float64
	AcidShop11   field.float64
	AcidShop12   field.float64
	AcidShop13   field.float64
	AcidShop14   field.float64
...
func (a *acidShop) updateTableName(table string) *acidShop {
	...
	a.AcidShop10 = field.Newfloat64(table, "acid_shop10")
	a.AcidShop11 = field.Newfloat64(table, "acid_shop11")
	a.AcidShop12 = field.Newfloat64(table, "acid_shop12")
	a.AcidShop13 = field.Newfloat64(table, "acid_shop13")
	a.AcidShop14 = field.Newfloat64(table, "acid_shop14")
