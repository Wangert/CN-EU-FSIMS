...
func newDivShop(db *gorm.DB, opts ...gen.DOOption) divShop {
	...
	_divShop.DivShop10 = field.Newfloat64(tableName, "div_shop10")
	_divShop.DivShop11 = field.Newfloat64(tableName, "div_shop11")
	_divShop.DivShop12 = field.Newfloat64(tableName, "div_shop12")
	_divShop.DivShop13 = field.Newfloat64(tableName, "div_shop13")
	_divShop.DivShop14 = field.Newfloat64(tableName, "div_shop14")
...
type divShop struct {
	...
	DivShop10    field.float64
	DivShop11    field.float64
	DivShop12    field.float64
	DivShop13    field.float64
	DivShop14    field.float64
...
func (d *divShop) updateTableName(table string) *divShop {
	...
	d.DivShop10 = field.Newfloat64(table, "div_shop10")
	d.DivShop11 = field.Newfloat64(table, "div_shop11")
	d.DivShop12 = field.Newfloat64(table, "div_shop12")
	d.DivShop13 = field.Newfloat64(table, "div_shop13")
	d.DivShop14 = field.Newfloat64(table, "div_shop14")
